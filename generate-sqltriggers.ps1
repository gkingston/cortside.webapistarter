...
if ($PSScriptRoot.Contains(' ')) { 
    throw "Your working directory has a space in the path, which is not supported.  Wise up and move to C:\work\enerbank.documents! And have a wonderful day. PS. Don't get *triggered*. ha ha... ha... ha.... I'll show myself out."
    exit
}
